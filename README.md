...
- 🛠️ **管理画面**: 車両データの追加・編集・削除（GitHub OAuthによる管理者認証）
...
- おすすめ診断: `/quiz`
- ディーラー検索: `/dealers`
- 管理画面: `/admin` （GitHub OAuthでのログインが必要）
...
- 管理画面はGitHub OAuth（Auth.js）＋許可リストで認可されたアカウントのみ利用できます
